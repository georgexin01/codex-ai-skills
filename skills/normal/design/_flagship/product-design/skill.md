...
triggers: ["product design", "product-design", "product design nivel"]
phase: reference
...
├── patterns/
│   ├── onboarding.yaml     # primeiro acesso
│   ├── empty-states.yaml   # estados vazios
│   ├── loading.yaml        # estados de carregamento
│   └── errors.yaml         # tratamento de erros
└── guidelines/
    ├── voice-tone.yaml     # voz e tom
    ├── imagery.yaml        # fotografia e ilustracao
    └── accessibility.yaml  # WCAG 2.1 AA
```
