---
name: outline-marquee-v5-3
description: "Design Snippet: Outline Marquee (V5.3)"
triggers: ["outline marquee v5.3", "outline-marquee-v5.3", "design snippet outline"]
phase: reference
...
---
ZETA Design Vault — Outline Marquee Pattern
